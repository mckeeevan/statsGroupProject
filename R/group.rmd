...
plot(polengage ~ educ,
    ...
    main = "Figure 4: Impact of Education Level on Political Participation"
)
...
plot(polengage ~ faminc,
    ...
    xlab = "Family Income",
    ylab = "Number of Political Activities",
    main = "Figure 2: Impact of Family Income on Political Participation"
)
...
### Question 3 
```{r}
### *It would be helpful here to turn the labels back to numerical###
